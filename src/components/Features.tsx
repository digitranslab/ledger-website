      ...
      <div className="container mx-auto px-4 z-1 relative">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[40px] md:gap-[45px]">
          ...
          <Feature
            ...
            desc={
              'You do not have to wait to end of the month to generate business reports. Ledger has financial reports to run your business with intelligence.'
            }
          />
          <Feature
          ...
          <Feature
            ...
            desc={
              'The software should facilitate collaboration with your accountant, Ledger allows to invite users to your organization with role-based permissions.'
            }
          />
          <Feature
          ...
          <Feature
            ...
            desc={
              'Ledger provides free online support, 12 hours a day seven days a week, even if you were using a free subscription plan.'
            }
          />
          <Feature
