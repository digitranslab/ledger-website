  ...
  return (
    ...
    >
      <div className="container lg-auto mx-auto px-4">
        ...
        {/* <div className={'mb4'}>
          <a
            href="https://www.producthunt.com/posts/ledger?embed=true&amp;utm_source=badge-featured&amp;utm_medium=badge&amp;utm_souce=badge-ledger"
            target="_blank"
            className={'display-inline'}
          >
            <img
              src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=481388&amp;theme=neutral"
              alt="Ledger - Modern, open-source core accounting software  | Product Hunt"
